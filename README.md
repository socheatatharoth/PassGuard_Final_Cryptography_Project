...
PASSGUARD_FINAL/<br>
│
├── .gitignore<br>                # Git configuration to ignore sensitive or unnecessary files
├── app.py<br>                    # Main application entry point
├── cert.pem<br>                  # SSL certificate for HTTPS
├── key.pem<br>                   # SSL key for HTTPS
